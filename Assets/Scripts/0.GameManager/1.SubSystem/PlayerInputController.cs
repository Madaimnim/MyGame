...
public class PlayerInputController :SubSystemBase,IInputProvider
{
    ...
    private PlayerStateSystem _playerStateSystem => GameManager.PlayerStateSystem;
    ...
    public void SelectDefaultPlayer() {
        var ids = _playerStateSystem.BattleObjects.Keys.ToList();
    ...
    private void HandlePlayerSwitch() {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            foreach (var hit in hits)
                foreach (var kvp in _playerStateSystem.BattleObjects)
    ...
    private void SelectPlayer(int index) {
        ...
        // 選中的 → 玩家控制
        var selectedPlayer = _playerStateSystem.BattleObjects[_currentPlayerId].GetComponent<Player>();
