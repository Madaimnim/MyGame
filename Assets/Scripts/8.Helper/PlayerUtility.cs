...
public static class PlayerUtility
{
    ...
    public static IReadOnlyDictionary<int, Player>  AllPlayers
    => GameManager.Instance.PlayerStateSystem.BattlePlayerDtny;
    public static List<int> UnlockedIdList
          => GameManager.Instance.PlayerStateSystem.UnlockedIdList;
